...
const Services = () => {
  ...
  return <section id="servicos" className="py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-demoop-teal hover:border-demoop-blue">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-demoop-teal to-demoop-blue rounded-2xl p-8 md:p-12 text-white">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-zinc-950">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/5548999982838" target="_blank" rel="noopener noreferrer" className="bg-white text-demoop-teal px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 inline-flex items-center justify-center" aria-label="Entre em contato via WhatsApp">
                WhatsApp: (48) 99998-2838
              </a>
              <a href="mailto:demoop@outlook.com" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-demoop-teal transition-all duration-300 inline-flex items-center justify-center" aria-label="Entre em contato via e-mail">
                demoop@outlook.com
              </a>
            </div>
          </div>
